...
def settings_view(request):
    ...
    if request.method == 'GET':
        ...
        if game_config:
            game_data = {
                ...
                'card_back_image_url': game_config.card_back_image_url or '',
    ...
    if game_data and game_config:
        game_fields = ['house_edge_percent', 'min_deposit', 'max_cashout', 'min_stake',
                       ...
                       'flip_sound_enabled', 'flip_sound_url', 'card_back_image_url', 'simulated_feed_enabled', 'simulated_feed_data',
